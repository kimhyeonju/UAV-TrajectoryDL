...
# 결과 저장 경로 설정
predictions_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/test_predictions_general_add/'
plots_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/test_plot_general_add/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/training_log_addition.txt'
...
# 이미 학습된 모델 로드
model_path = '/Users/admin/PycharmProjects/GP_test/GP_final/drone/model/GRU_model_general_drone.h5'
...
for file_name in file_list:
    ...
    model.fit(X_train, y_train, epochs=10, batch_size=32, verbose=0)  # 추가 학습
    ...
    print(df_filtered_trimmed.head())

    print("Predicted Data (first 5 rows):")
    print(predicted_df.head())

    print("Actual Data (first 5 rows):")
    print(actual_df.head())

    print("Trimmed Actual Data (first 5 rows):")
    print(actual_df_trimmed.head())

    # 예측 결과를 CSV 파일로 저장
    predicted_df.to_csv(f'{predictions_path}{file_name}_test_predictions_general_addition.csv', index=False)
    ...
    # 플롯 저장
    plt.savefig(f'{plots_path}{file_name}_test_plot_addition.png')
    plt.close(fig)
