...
# 결과 저장 경로 설정
predictions_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/TimeSeriesSplit/look_back=50&forward=0/test_predictions_TimeSeriesSplit/'
plots_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/TimeSeriesSplit/look_back=50&forward=0/test_plot_TimeSeriesSplit/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/drone/TimeSeriesSplit/look_back=50&forward=0/training_log_TimeSeriesSplit.txt'
...
for file_name in file_list:
    ...
    for train_index, test_index in tscv.split(X):
        ...
        # 예측 결과를 CSV 파일로 저장
        fold_predictions_path = f'{predictions_path}{file_name}_fold{fold}_test_predictions_new_TimeSeriesSplit.csv'
        ...
        # 플롯 제목 설정
        plt.title(f"{file_name}, fold {fold}, look_back = 50, forward_length = 0")
        ...
        # 플롯 저장
        plt.savefig(f'{plots_path}{file_name}_fold{fold}_TimeSeriesSplit_new_test_plot.png')
        plt.close(fig)

# 최종 학습된 모델 저장
model.save('/Users/admin/PycharmProjects/GP_test/GP_final/drone/model/TimeSeriesSplit/look_back=50&forward=0/GRU_model_TimeSeriesSplit_drone.h5')
