...
# 파일 폴더 경로 설정
folder_path = '/Users/admin/PycharmProjects/GP_test/data/interpolation_s'
file_list = [file for file in os.listdir(folder_path) if file.endswith('.csv')]

# 결과 저장 경로 설정
predictions_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/aircraft/look_back=30&forward=15/test_predictions_general/'
plots_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/aircraft/look_back=30&forward=15/test_plot_general/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = '/Users/admin/PycharmProjects/GP_test/GP_final/data/aircraft/look_back=30&forward=15/training_log_general.txt'
...
# 최종 학습된 모델 저장
model.save('/Users/admin/PycharmProjects/GP_test/GP_final/aircraft/model/look_back=30&forward=15/GRU_model.h5')
