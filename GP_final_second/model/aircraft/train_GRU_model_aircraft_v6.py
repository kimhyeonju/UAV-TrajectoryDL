...
from GRU_model_v6 import create_weighted_input_model6
...
# 결과 저장 경로 설정
predictions_path = '/Users/admin/PycharmProjects/GP_test/GP_final_second/data/aircraft/GRU_model_v6/look_back=10&forward=0/test_predictions_general/'
plots_path = '/Users/admin/PycharmProjects/GP_test/GP_final_second/data/aircraft/GRU_model_v6/look_back=10&forward=0/test_plot_general/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = '/Users/admin/PycharmProjects/GP_test/GP_final_second/data/aircraft/GRU_model_v6/look_back=10&forward=0/training_log_general.txt'
...
for file_name in file_list:
    ...
    model = create_weighted_input_model6(
...
# 최종 학습된 모델 저장
model.save(
    '/Users/admin/PycharmProjects/GP_test/GP_final_second/SaveModel/aircraft_SaveModel/GRU_model_v6/look_back=10&forward=0/gru_model_6.h5')
