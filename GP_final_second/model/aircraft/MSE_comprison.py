...
file1_mse_data = extract_mse_data('/Users/admin/PycharmProjects/GP_test/GP_final_second/data/aircraft/GRU_model_v8/look_back=10&forward=0/training_log_general.txt')
file2_mse_data = extract_mse_data('/Users/admin/PycharmProjects/GP_test/GP_final_second/data/aircraft/GRU_model_v7/look_back=10&forward=0/training_log_general.txt')
