...
from GP_final_second.model.aircraft.Bi_diresctional_GRU_model_v4 import create_Bi_gru_model4
...
# 결과 저장 경로 설정
predictions_path = '/GP_final_second/data/aircraft/bi_gru_model_v4/aircraft/look_back=10&forward=0/test_predictions_general/'
plots_path = '/GP_final_second/data/aircraft/bi_gru_model_v4/aircraft/look_back=10&forward=0/test_plot_general/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = '/GP_final_second/data/aircraft/bi_gru_model_v4/aircraft/look_back=10&forward=0/training_log_general.txt'
...
for file_name in file_list:
    ...
    # 모델 생성 및 학습
    model = create_Bi_gru_model4(input_shape=(look_back, 3))
...
# 최종 학습된 모델 저장
model.save('/Users/admin/PycharmProjects/GP_test/GP_final_second/aircraft/bi_gru_model_v4/look_back=10&forward=0/bi_GRU_model_v4.h5')
