...
from GRU_model_v6 import create_weighted_input_model
...
# 파일 폴더 경로 설정
folder_path = r'C:\Users\kimhyeonju\PycharmProjects\GP_test\GP_final_second\data\DataProcess\Results\RE_SplineInterpolation_1s'
file_list = [file for file in os.listdir(folder_path) if file.endswith('.csv')]

# 결과 저장 경로 설정
predictions_path = r'C:\Users\kimhyeonju\PycharmProjects\GP_test\GP_final_second\data\drone\GRU_model_v6\look_back=50&forward=25/test_predictions_general/'
plots_path = r'C:\Users\kimhyeonju\PycharmProjects\GP_test\GP_final_second\data\drone\GRU_model_v6\look_back=50&forward=25/test_plot_general/'
...
# 표준 출력을 파일로 리디렉션
log_file_path = r'C:\Users\kimhyeonju\PycharmProjects\GP_test\GP_final_second\data\drone\GRU_model_v6\look_back=50&forward=25/training_log_general.txt'
...
# 최종 학습된 모델 저장
model.save(
    r'C:\Users\kimhyeonju\PycharmProjects\GP_test\GP_final_second\SaveModel\drone_SaveModel\GRU_model_v6/look_back=50&forward=25/gru_model_6.h5')
